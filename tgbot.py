...
def mode_4(call):
    text = "Выбери категорию, чтобы я нашла тебе собеседника:"
    def markup():
        markup = InlineKeyboardMarkup()
        markup.row_width = 2
...
def mode_subject(call):
    text = "Выбери предмет, чтобы я нашла тебе собеседника, который в нем разбирается:"
...
def help_user(msg):
    text = """Найти собеседника - если хочешь найти собеседника, то пожалуйста кликай сюда и выбирай режим

Наиболее похожий собеседник - Выбирай это и я найду тебе брата/сестру по духу)😍

Наиболее непохожий собеседник - Если захочешь расширить кругозор, я поищу самого непохожего на тебя🔮

Поиск по категориям - Здесь я помогу тебе, если захочешь поболтать с кем-то на тему связанную со студ. объединениями, предметом или каким-либо институтом🤓

Полученные анкеты - здесь будут все люди которым ты понравился, Поздравляю🤗

Перезаполнить анкету - если ты хочешь чего нибудь поменять в своем замечательном профиле

Для связи с админом: @daniil_d_d
            """
    bot.send_message(msg.from_user.id, text)
